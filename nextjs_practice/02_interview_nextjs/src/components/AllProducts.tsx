			...
			<div className="max-h-[84vh] overflow-y-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 w-full p-8">
				{allProducts?.map((product: Product) => (
					<div key={product.id} className="h-full">
						<div className=" rounded-xl shadow-lg transform hover:bg-gray-50  hover:shadow-xl p-8 h-full text-center border-l-4 border-indigo-600 transition-all duration-300 ease-linear ">
							{/* Image section */}
							...
							<h3 className="text-xl font-semibold my-8 text-purple-800">
								{product.title}
							</h3>
